package br.com.GabrielIDSM.EncryptorAPI.Error;
...
public class ValidationErrorDetails {
    ...
    public static class Builder {
        ...
        public ValidationErrorDetails build() {
            return new br.com.GabrielIDSM.EncryptorAPI.Error.ValidationErrorDetails(title, status, detail, timestamp, developerMessage, field, fieldMessages);
        }
    }

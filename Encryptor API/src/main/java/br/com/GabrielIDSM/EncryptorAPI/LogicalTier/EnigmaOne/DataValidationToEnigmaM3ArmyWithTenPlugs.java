...
public class DataValidationToEnigmaM3ArmyWithTenPlugs {
    public static boolean isMessageRequestModelValid (MessageRequestModelToEnigmaM3ArmyWithTenPlugs requestModel){
        try{
    ...
    private static int[] createArrayWithPlugLetters(MessageRequestModelToEnigmaM3ArmyWithTenPlugs messageRequest){
